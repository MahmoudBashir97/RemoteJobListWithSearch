...
import com.mahmoudbashir.searchremotejobs_app.databinding.FragmentMainBinding
    ...
    private fun setUpTabBar() {
        val adapter = FragmentPagerItemAdapter(
            ...
            FragmentPagerItems.with(activity)
                .add("Jobs",RemoteJobsListFragment::class.java)
                .add("Search",SearchJobsFragment::class.java)
